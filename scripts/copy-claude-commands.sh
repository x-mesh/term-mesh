#!/bin/bash
# Copy Claude slash commands + skills to the app bundle with managed-file markers.
#
# Invoked from the Xcode "Run Script" build phase (see GhosttyTabs.xcodeproj/project.pbxproj).
# This is the SINGLE source of truth for which commands/skills ship in the .app
...
# Codex IME aliases read these same command files through imeSlashCommandAliases().
set -euo pipefail
