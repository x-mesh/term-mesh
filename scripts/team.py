...
AGENT_INIT_PROMPT = (
    ...
    'Use `tm-rpc` if available (Rust, ~2ms), otherwise `./scripts/tm-rpc.sh` (bash, ~10ms).\n'
    '- Report: `tm-rpc report \'<summary>\'`\n'
    '- Heartbeat: `tm-rpc heartbeat \'<status>\'`\n'
    '- Message: `tm-rpc msg \'<text>\' --to <agent_name>`\n'
    '- Task done: `tm-rpc task-done <task_id> \'<result>\'`\n'
    '- Check status: `tm-rpc status`\n'
    '- Check inbox: `tm-rpc inbox`\n'
    'Both are ~15-30x faster than team.py (~250ms). '
    'Use team.py for complex operations (create, delegate, read, collect, reply).\n'
    '\n'
    'Environment:\n'
