...
- Before dispatch, form the policy v13 structured task contract with worker, goal, owned/forbidden paths, dependencies, verify command, mutation flag, and estimate; dispatch only those tasks
