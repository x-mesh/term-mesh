# term-mesh terminfo overlay

term-mesh ships Ghostty's `xterm-ghostty` terminfo entry, but the embedded
renderer in term-mesh has differed from Ghostty's app renderer in how it treats
