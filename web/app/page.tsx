    ...
    <div className="min-h-screen">
      ...
      <main className="w-full max-w-2xl mx-auto px-6 py-16 sm:py-24">
        ...
        <div className="flex items-center gap-4 mb-10" data-dev="header">
          ...
          />
          <h1 className="text-2xl font-semibold tracking-tight">term-mesh</h1>
        </div>
        ...
        <div data-dev="screenshot" className="mb-12 -mx-6 sm:-mx-24 md:-mx-40 lg:-mx-72 xl:-mx-96">
          <FadeImage
            src={landingImage}
            alt="term-mesh terminal app screenshot"
            priority
        ...
        <section data-dev="faq" className="mb-10">
          ...
          <div className="space-y-5 text-[15px]" style={{ lineHeight: 1.5 }}>
            <div>
              <p className="font-medium mb-1">How does term-mesh relate to Ghostty?</p>
              <p className="text-muted">
                term-mesh is not a fork of Ghostty. It uses{" "}
                ...
                Ghostty is a standalone terminal; term-mesh is a different app built on top of its rendering engine.
              </p>
            </div>
            <div>
              <p className="font-medium mb-1">What platforms does it support?</p>
              <p className="text-muted">
                macOS only, for now. term-mesh is a native Swift + AppKit app.
              </p>
            </div>
            <div>
              <p className="font-medium mb-1">What coding agents does term-mesh work with?</p>
              <p className="text-muted">
                All of them. term-mesh is a terminal, so any agent that runs in a terminal works out of the
            ...
            <div>
              ...
              <p className="text-muted">
                When a process needs attention, term-mesh shows notification rings around panes,
                ...
                <a href="/docs/notifications" className="underline underline-offset-2 decoration-border hover:decoration-foreground transition-colors">term-mesh CLI</a>{" "}
                and{" "}
            ...
            <div>
              ...
              <p className="text-muted">
                ...
                term-mesh-specific shortcuts (workspaces, splits, browser, notifications) can be
            ...
            <div>
              ...
              <p className="text-muted">
                tmux is a terminal multiplexer that runs inside any terminal. term-mesh is a native macOS app
            ...
            <div>
              <p className="font-medium mb-1">Is term-mesh free?</p>
              <p className="text-muted">
                Yes, term-mesh is free to use. The source code is available on{" "}
                <a href="https://github.com/JINWOO-J/term-mesh" className="underline underline-offset-2 decoration-border hover:decoration-foreground transition-colors">GitHub</a>.
              </p>
            </div>
          </div>
        </section>
