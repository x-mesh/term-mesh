...
export const metadata: Metadata = {
  title: "Community — term-mesh",
  description: "Join the term-mesh community on Discord, Twitter, GitHub, and more",
};
    ...
    <div className="min-h-screen">
      ...
      <main className="w-full max-w-6xl mx-auto px-6 py-10">
        ...
        <p className="text-muted text-[15px] mb-8">
          Connect with other term-mesh users and the team behind it.
        </p>
