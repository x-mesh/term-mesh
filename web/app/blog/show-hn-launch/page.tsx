...
export const metadata: Metadata = {
  ...
  description:
    "term-mesh launched on Hacker News, hit #2, went viral in Japan, and people started building extensions on the CLI. Here's what happened.",
  keywords: [
    "term-mesh",
    "Show HN",
    "Hacker News",
  ...
  openGraph: {
    title: "Launching term-mesh on Show HN",
    description:
      "term-mesh launched on Hacker News, hit #2, went viral in Japan, and people started building extensions on the CLI.",
    type: "article",
    publishedTime: "2026-02-21T00:00:00Z",
    url: "https://term-mesh.dev/blog/show-hn-launch",
  },
  twitter: {
    card: "summary",
    title: "Launching term-mesh on Show HN",
  ...
  alternates: {
    canonical: "https://term-mesh.dev/blog/show-hn-launch",
  },
};
    ...
    <>
      ...
      <blockquote className="border-l-2 border-border pl-4 my-6 text-muted space-y-3 text-[15px]">
        ...
        <p>
          ...
          since GUI orchestrators lock you into their workflow. So I built term-mesh as
        ...
        <p>
          ...
          CLI (term-mesh notify) you can wire into agent hooks for Claude Code,
          ...
          <li>
            ...
            <ul className="list-disc pl-5 mt-1 space-y-1">
              <li>
                ...
                remapped in my ghostty config that conflict with some term-mesh
      ...
      <p>
        Surprisingly, term-mesh went viral in Japan:
      </p>
      ...
      <p>
        Another exciting thing was seeing people build on top of the term-mesh
        CLI. sasha built a pi-term-mesh extension that shows model info, token
      ...
      <p>
        Everything in term-mesh is scriptable through the CLI: creating workspaces,
        sending keystrokes, controlling the browser, reading notifications.
        Part of the term-mesh philosophy is being programmable and composable, so
      ...
      <p>
        ...
        <a href="https://github.com/JINWOO-J/term-mesh">give term-mesh a try</a>.
      </p>

      <div className="my-6">
        <Image
          src={starHistory}
          alt="term-mesh GitHub star history showing growth from near 0 to 900+ stars after the Show HN launch"
          placeholder="blur"
