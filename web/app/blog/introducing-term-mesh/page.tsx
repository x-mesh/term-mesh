...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://term-mesh.dev/blog/introducing-term-mesh",
  },
  twitter: {
    card: "summary",
    title: "Introducing term-mesh",
  ...
  alternates: {
    canonical: "https://term-mesh.dev/blog/introducing-term-mesh",
  },
};
...
export default function IntroducingCmuxPage() {
  return (
    <>
      ...
      <h1>Introducing term-mesh</h1>
      <time dateTime="2026-02-12" className="text-sm text-muted">February 12, 2026</time>

      <p className="mt-6">
        term-mesh is a native macOS terminal application built on top of Ghostty,
      ...
      <p>
        ...
        between them quickly is the problem term-mesh solves.
      </p>
      ...
      <h2>Get started</h2>
      <p>
        Install term-mesh via Homebrew or download the DMG from the{" "}
