...
Why this matters for termmesh:
- termmesh sets ZDOTDIR to the app wrapper directory so zsh loads wrapper
  startup files.
...
def main() -> int:
    ...
    base = Path("/tmp") / f"termmesh_zdotdir_user_override_{os.getpid()}"
    try:
