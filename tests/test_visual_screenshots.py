...
def verify_views_in_window(client: termmesh, label: str = "", timeout: float = 8.0) -> Optional[str]:
...
def _close_and_verify(client: termmesh, change: StateChange, close_idx: Union[int, str],
