#!/usr/bin/env python3
"""
Interactive test for Ctrl+C and Ctrl+D in termmesh terminal.

This script tests that control signals are properly handled.
Run this script inside the termmesh terminal.
...
def main():
    print("=" * 50)
    print("termmesh Control Signal Test")
    print("=" * 50)
    print("\nThis script tests if Ctrl+C and Ctrl+D work correctly.")
    print("Run this inside the termmesh terminal to verify the fix.\n")
