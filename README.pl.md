...
Otwórz plik `.dmg` i przeciągnij term-mesh do folderu Aplikacje. term-mesh aktualizuje się automatycznie przez Sparkle, więc musisz pobrać go tylko raz.
