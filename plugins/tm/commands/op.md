...
For strategies already implemented by the project-local command wrapper, follow the repository's `.codex/prompts/tm-op.md` workflow and keep every team operation on `tm-agent`.
