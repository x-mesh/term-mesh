...
def test_goto_split_roundtrip_loaded_browser(client: termmesh) -> tuple[bool, str]:
    """
...
def run_tests() -> int:
    print("=" * 60)
    print("termmesh Browser goto_split Regression Test")
    print("=" * 60)
    print()
    ...
    try:
        with termmesh(socket_path=socket_path) as client:
