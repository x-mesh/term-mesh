...
struct SplitContainerView<Content: View, EmptyContent: View>: NSViewRepresentable {
    ...
    class Coordinator: NSObject, NSSplitViewDelegate {
        ...
        /// Sync the model's divider position to the NSSplitView.
        ...
        func syncPosition(_ statePosition: CGFloat, in splitView: NSSplitView, layout: Bool = true) {
            ...
            setPositionSafely(pixelPosition, in: splitView, layout: layout)
        ...
        func splitViewDidResizeSubviews(_ notification: Notification) {
            ...
            if let firstSubview = splitView.arrangedSubviews.first {
                ...
                guard wasDragging else {
                    ...
                    // Re-assert the model position synchronously, but skip layoutSubtreeIfNeeded().
                    // We are already inside a resize/layout pass; forcing a nested layout triggers
