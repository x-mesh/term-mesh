...
final class WindowToolbarController: NSObject, NSToolbarDelegate {
    private let commandItemIdentifier = NSToolbarItem.Identifier("term-mesh.focusedCommand")
    ...
    private func attach(to window: NSWindow) {
        ...
        let toolbar = NSToolbar(identifier: NSToolbar.Identifier("term-mesh.toolbar"))
