...
final class UpdateTestURLProtocol: URLProtocol {
    static let host = "term-mesh.test"
    static let appcastPath = "/appcast.xml"
    static let updatePath = "/term-mesh-test.zip"
    ...
    private static func appcastData() -> Data {
        ...
        let mode = (env["TERMMESH_UI_TEST_FEED_MODE"] ?? env["CMUX_UI_TEST_FEED_MODE"]) ?? "available"
        ...
        <rss version="2.0"
          ...
          <channel>
            <title>term-mesh Test Updates</title>
    ...
    private static func updateArchiveData() -> Data {
        Data("term-mesh test update".utf8)
    }
}
#endif
