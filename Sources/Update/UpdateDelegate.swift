...
enum UpdateFeedResolver {
    static let fallbackFeedURL = "https://github.com/manaflow-ai/term-mesh/releases/latest/download/appcast.xml"
...
extension UpdateDriver: SPUUpdaterDelegate {
    func feedURLString(for updater: SPUUpdater) -> String? {
        ...
        if let override = (env["TERMMESH_UI_TEST_FEED_URL"] ?? env["CMUX_UI_TEST_FEED_URL"]), !override.isEmpty {
        ...
        // - term-mesh NIGHTLY has the nightly appcast URL injected by CI
