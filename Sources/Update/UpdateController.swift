...
/// Controller for managing Sparkle updates in term-mesh.
class UpdateController {
    ...
    func startUpdaterIfNeeded() {
        ...
        if termMeshEnv("UI_TEST_RESET_SPARKLE_PERMISSION") == "1" {
            let defaults = UserDefaults.standard
...
#endif
        do {
            // term-mesh never enables automatic update checks; we rely on the in-app update pill.
