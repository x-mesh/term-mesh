...
final class UpdateLogStore {
    ...
    private let queue = DispatchQueue(label: "term-mesh.update.log")
    ...
    private init() {
        ...
        logURL = logsDir.appendingPathComponent("Logs/term-mesh-update.log")
        ensureLogFile()
    }
...
final class FocusLogStore {
    ...
    private let queue = DispatchQueue(label: "term-mesh.focus.log")
    private var entries: [String] = []
    ...
    private init() {
        ...
        let logsDir = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask).first
            ?? FileManager.default.temporaryDirectory
        logURL = logsDir.appendingPathComponent("Logs/term-mesh-focus.log")
        ensureLogFile()
    }
