...
class TerminalController {
    ...
    var debugProjectBootstrapStatus: [String: [String: Any]] = [:]
    ...
    private func processV2Command(
        ...
        case "debug.project.create_status":
            return v2Result(id: id, self.v2DebugProjectCreateStatus(params: params))
        ...
        case "debug.project.adopt_remote":
            return v2Result(id: id, self.v2DebugProjectAdoptRemote(params: params))
        case "debug.project.layout":
            return v2Result(id: id, self.v2DebugProjectLayout(params: params))
        ...
        case "debug.peer.host_status":
            return v2Result(id: id, self.v2DebugPeerHostStatus(params: params))
        case "debug.peer.mirror_drop_subscription":
            return v2Result(id: id, self.v2DebugPeerMirrorDropSubscription(params: params))
        case "debug.peer.mirror_drop_pane_transport":
            return v2Result(id: id, self.v2DebugPeerMirrorDropPaneTransport(params: params))
